              ...
              Expanded(
                child: Builder(
                  builder: (context) {
                    ...
                    final int adCount = tradeCount > 0
                        ? (tradeCount / adInterval).floor()
                        : 0;
                    final int totalItemCount = tradeCount + adCount;

                    // Debug log
                    Logger.info(
                      'ListView itemCount hesaplaması: tradeCount=$tradeCount, adCount=$adCount, totalItemCount=$totalItemCount',
                      tag: 'TradeView',
                    );
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, displayIndex) {
                          try {
                            ...
                            if (dataIndex < 0 || dataIndex >= tradeCount) {
                              Logger.warning(
                                'ListView index hatası: displayIndex=$displayIndex, dataIndex=$dataIndex, tradeCount=$tradeCount',
                                tag: 'TradeView',
                              );
                            ...
                            final updatedTrade =
                                tradeViewModel.getTradeByOfferId(
                                  trade.offerID,
                                ) ??
                                trade;
                            ...
                            return Container(
                              ...
                              child: TradeCard(
                                ...
                                onStatusChange: (newStatusId) async {
                                  ...
                                  final userToken = await authService
                                      .getToken();
                            ...
                            Logger.error(
                              'ListView itemBuilder hatası: $e, displayIndex=$displayIndex',
                              tag: 'TradeView',
                            );
                            return Container(); // Hata durumunda boş container
                          }
                        },
                      ),
                    );
        ...
        return Container(
          ...
          child: RefreshIndicator(
            ...
            child: Padding(
              ...
              child: Builder(
                builder: (context) {
                  // Güvenli itemCount hesaplama
                  final int favoriteCount =
                      productViewModel.favoriteProducts.length;

                  // Her 2 ürünten sonra 1 reklam kartı ekle
                  const int adInterval = 2;
                  final int adCount = favoriteCount > 0
                      ? (favoriteCount / adInterval).floor()
                      : 0;
                  final int totalItemCount = favoriteCount + adCount;

                  // Debug log
                  Logger.info(
                    'GridView itemCount hesaplaması: favoriteCount=$favoriteCount, adCount=$adCount, totalItemCount=$totalItemCount',
                    tag: 'TradeView',
                  );
                  ...
                  return GridView.builder(
                    ...
                    itemBuilder: (context, displayIndex) {
                      try {
                        ...
                        if (displayIndex < 0 ||
                            displayIndex >= totalItemCount) {
                          Logger.warning(
                            'GridView index out of bounds: displayIndex=$displayIndex, totalItemCount=$totalItemCount',
                            tag: 'TradeView',
                          );
                        ...
                        // Index sınırlarını kontrol et
                        if (dataIndex < 0 || dataIndex >= favoriteCount) {
                          Logger.warning(
                            'GridView index hatası: displayIndex=$displayIndex, dataIndex=$dataIndex, favoriteCount=$favoriteCount',
                            tag: 'TradeView',
                          );
                        ...
                        if (product == null) {
                          Logger.warning(
                            'Product null: dataIndex=$dataIndex',
                            tag: 'TradeView',
                          );
                          return const SizedBox.shrink(); // Boş widget döndür
                        }
                        ...
                        Logger.error(
                          'GridView itemBuilder hatası: $e, displayIndex=$displayIndex',
                          tag: 'TradeView',
                        );
                        return const SizedBox.shrink(); // Hata durumunda boş widget
                      }
                    },
                  );
                },
