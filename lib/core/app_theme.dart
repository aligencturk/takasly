...
class AppTheme {
  ...
  static const Color textPrimary = Color(0xFF212121); // Ana Metin Rengi (Koyu Gri)
  static const Color textSecondary = Color(0xFF757575); // İkincil Metin Rengi (Orta Gri)
  ...
  static final TextTheme _textTheme = TextTheme(
    ...
    labelLarge: GoogleFonts.inter(fontSize: 14, fontWeight: FontWeight.w600, color: Colors.white), // Buton metni
  );
  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        hintStyle: _textTheme.bodyLarge?.copyWith(color: textSecondary.withOpacity(0.7)),
      ),
